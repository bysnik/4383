...
image bg office_window = "images/bg/bg_office_window.png" # Окно и вид на город, под углом сверху вниз
...
image bg kindergarten = "images/bg/bg_kindergarten.png" # детский сад, общий план
image bg street = "images/bg/bg_street.png" # универсальная улица
...
image head normal = Glitch("images/sprites/head_normal.png") #https://github.com/NyashniyVladya/RenPyGlitchs  
