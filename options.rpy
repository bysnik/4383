...
Данная игра является некоммерческим фанатским проектом, созданным на основе вселенной «Kim Possible» (Ким Пять-с-плюсом).

Все права на оригинальных персонажей, локации и элементы вселенной принадлежат:

— The Walt Disney Company 

— Disney Channel  

— Создателям оригинального мультсериала: Бобу Шули и Марку МакКорклу

Данный фан-проект создан исключительно в некоммерческих целях, из любви к оригинальному произведению. Авторы проекта не претендуют на права интеллектуальной собственности, связанные с вселенной «Kim Possible». Любое коммерческое использование запрещено.

Этот проект — дань уважения оригиналу. Мы не претендуем на канон.

Содержит:

— Сцены жестокости и насилия (в том числе сцены пыток и убийств);
— Психологическое давление и изображение психических расстройств;
— Травмы, инвалидность, последствия физических увечий;
— Тёмные, депрессивные темы (потеря близких, суицидальные мысли, месть).

Если вы чувствительны к любым из перечисленных тем, пожалуйста, воздержитесь от прохождения.
""")
...
define config.save_directory = "testproject-1773300193"
